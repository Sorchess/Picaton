...
5. Если запрос - это задача (например "сделать сайт"), включи специалистов, которые решают эту задачу
6. Максимум 15 связанных терминов
7. Термины должны быть короткими (1-3 слова)
8. Отвечай ТОЛЬКО JSON массивом, без пояснений
...
Запрос: "сделать сайт"
Ответ: ["веб-разработчик", "верстальщик", "фронтенд", "frontend", "html", "css", "javascript", "react", "vue", "верстка", "дизайн", "веб-дизайнер", "лендинг", "адаптивная верстка"]
"""
